...
public class ReadNegotiationPolicyInput {
	
	
	
 	
		 public List<NegotiatePolicyFormat> inputList=new ArrayList<NegotiatePolicyFormat>();
		 NegotiatePolicyFormat inputFormat=null;
		 public int rIndex;
                ...
                while (rowIterator.hasNext()) 
                {
                    ...
                    while (cellIterator.hasNext()) 
                    {
                        ...
                        case 0:
                        	...
                        	break;
                         case 1:
                        	noOfPax=(String) getCellValue(nextCell);
                        	break;
                        case 2:
                        ...
                        case 3:
                        	...
                        	break;
                        case 4:
                        	noOfTime=(String) getCellValue(nextCell);
                        	break;        
                        case 5:
                     ...
                     inputFormat = new NegotiatePolicyFormat(slNo,noOfPax,tripType,requestType,noOfTime,runningMode);
	...
	public String getDetails(String fieldName,int rowNo){
		...
		fieldName=fieldName.toUpperCase();
		 ...
		 case "SLNO": 
			 ...
			 break;  
		 case "NOOFPAX": 
			 fieldValue= inputList.get(rowNo).getNoOfPax();
			 break;  
		 ...
		 case "NOOFTIME": 
			 fieldValue= inputList.get(rowNo).getNoOfTime();
			 break; 
