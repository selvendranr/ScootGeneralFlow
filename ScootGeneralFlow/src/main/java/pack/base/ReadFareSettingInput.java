...
public class ReadFareSettingInput {
	...
	//String fileName="D:\\AutomationBackUpFiles\\CommonBackGroupRMBackupFiles\\InputFile\\Input Data.xls";
		 ...
		 public List<FareSettingsFormat> inputList=new ArrayList<FareSettingsFormat>();
		 FareSettingsFormat inputFormat=null;
		 public int rIndex;
            ...
            for(int i=0; i < numberOfSheets; i++){
                ...
                while (rowIterator.hasNext()) 
                {
                    ...
                    while (cellIterator.hasNext()) 
                    {
                     ...
                     inputFormat = new FareSettingsFormat(slNo,tripType,requestType,runningMode);
