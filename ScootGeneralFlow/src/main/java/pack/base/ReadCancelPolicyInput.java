...
public class ReadCancelPolicyInput {
	
	
	
 	
		 public List<CancelPolicyFormat> inputList=new ArrayList<CancelPolicyFormat>();
		 CancelPolicyFormat inputFormat=null;
		 public int rIndex;
            ...
            for(int i=0; i < numberOfSheets; i++){
                ...
                while (rowIterator.hasNext()) 
                {
                    ...
                    while (cellIterator.hasNext()) 
                    {
                     ...
                     inputFormat = new CancelPolicyFormat(slNo,noOfPax,tripType,requestType,runningMode);
