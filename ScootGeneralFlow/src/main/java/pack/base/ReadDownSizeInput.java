...
public class ReadDownSizeInput {
	
	
	

	//String fileName="D:\\AutomationBackUpFiles\\CommonBackGroupRMBackupFiles\\InputFile\\Input Data.xls";



	
		 public List<DownSizeFormat> inputList=new ArrayList<DownSizeFormat>();
		 DownSizeFormat inputFormat=null;
		 public int rIndex;
                ...
                while (rowIterator.hasNext()) 
                {
                    ...
                    while (cellIterator.hasNext()) 
                    {
                      ...
                      case 0:
                      	...
                      	break;
                      case 1:
                    	  when=(String) getCellValue(nextCell);
                      	break;
                      case 2:
                    	  scenario=(String) getCellValue(nextCell);
                      	break;
                     case 3:
                     ...
                     inputFormat = new DownSizeFormat(slNo,when,scenario,tripType,requestType,runningMode);
	...
	public String getDetails(String fieldName,int rowNo){
		...
		fieldName=fieldName.toUpperCase();
		 ...
		 case "SLNO": 
			 ...
			 break;  
		 case "WHEN": 
			 fieldValue= inputList.get(rowNo).getWhen();
			 break;  
		 case "SCENARIO": 
			 fieldValue= inputList.get(rowNo).getScenario();
			 break; 
