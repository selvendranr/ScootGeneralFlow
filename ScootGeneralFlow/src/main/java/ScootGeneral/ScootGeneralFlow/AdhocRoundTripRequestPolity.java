...
public class AdhocRoundTripRequestPolity extends TestBaseSetup {
...
WebElement wbEle;	
public AdhocRoundTripRequestPolity(WebDriver driver) {
	this.driver = driver;
}

public void adHocGroupRequest(String org,String dest,String noPaxMn,String noPaxMx,String noInfantMn,String noInfantMx) {
