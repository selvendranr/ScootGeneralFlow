...
public class AdhocMultiCityDiscount extends TestBaseSetup {
...
WebElement wbEle;	
public AdhocMultiCityDiscount(WebDriver driver) {
	this.driver = driver;
}

public void adHocGroupRequest(String org,String dest,String org2,String dest2,String org3,String dest3) {
...
System.out.println("Invalid");	
	...
	findEle(driver,origin+"1]","cssselector").sendKeys(org2);
	try {
		Thread.sleep(3000);
	} catch (InterruptedException e1) {
		// TODO Auto-generated catch block
	...
	findEle(driver,destination+"1]","cssselector").sendKeys(dest2);
	try {
		Thread.sleep(3000);
	} catch (InterruptedException e1) {
		// TODO Auto-generated catch block
	...
	findEle(driver,origin+"2]","cssselector").sendKeys(org3);
	try {
		Thread.sleep(3000);
	} catch (InterruptedException e1) {
		// TODO Auto-generated catch block
		...
		findEle(driver,destination+"2]","cssselector").sendKeys(dest3);
		try {
			Thread.sleep(3000);
		} catch (InterruptedException e1) {
			// TODO Auto-generated catch block
	...
	String sDate=""+randomDate;  
	  ...
	  findEle(driver,departureDateTxt+"1]","cssselector").click();
		...
		//	  noPaxInt=Integer.parseInt(noPax);
			  ...
			  paxInput(getRandomNumber(15,20),getRandomNumber(1,5),getRandomNumber(1,3));
