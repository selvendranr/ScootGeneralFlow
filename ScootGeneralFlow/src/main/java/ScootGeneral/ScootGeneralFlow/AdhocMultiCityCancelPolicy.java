...
public class AdhocMultiCityCancelPolicy extends TestBaseSetup {
...
String multiTrip = "label[for=tripType_three] span";
...
WebElement wbEle;	
public AdhocMultiCityCancelPolicy(WebDriver driver) {
	this.driver = driver;
}

public void adHocGroupRequest(String org,String dest,String noPax,String filePath,String delemiter) {
	...
	findEle(driver,origin+"0]","cssselector").sendKeys(sectorDetails[0]);
	try {
		Thread.sleep(3000);
	...
	findEle(driver,destination+"0]","cssselector").sendKeys(sectorDetails[1]);
	try {
		Thread.sleep(3000);
	} catch (InterruptedException e1) {
		// TODO Auto-generated catch block
	...
	findEle(driver,origin+"1]","cssselector").sendKeys(sectorDetails[2]);
	try {
		Thread.sleep(3000);
	} catch (InterruptedException e1) {
		// TODO Auto-generated catch block
	...
	findEle(driver,destination+"1]","cssselector").sendKeys(sectorDetails[3]);
	try {
		Thread.sleep(3000);
	} catch (InterruptedException e1) {
		// TODO Auto-generated catch block
	...
	findEle(driver,origin+"2]","cssselector").sendKeys(sectorDetails[4]);
	try {
		Thread.sleep(3000);
	} catch (InterruptedException e1) {
		// TODO Auto-generated catch block
		...
		findEle(driver,destination+"2]","cssselector").sendKeys(sectorDetails[5]);
		try {
			Thread.sleep(3000);
		} catch (InterruptedException e1) {
			// TODO Auto-generated catch block
		...
		waitExplicitlyByLocator(driver,departureDateMonth,"cssselector",60);
	  ...
	  wbEle=findEle(driver,succedMassage,"cssselector");
		...
		System.out.println("Adhoc One Way Groupt Request has been send"+requestID);
		 ...
		 findEle(driver,succedMsgOkBtn,"cssselector").click();	
			...
			waitExplicitlyByLocator(driver,logOut,"cssselector",40);
