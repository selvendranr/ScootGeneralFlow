...
public class MapDiscountPolicy extends TestBaseSetup {
...
protected WebDriver driver;
	...
	String mapMatrix="ul>li[class='discountPolicyQueryBox']>a";

	String create="//span[text()='Create']/..";
	String requestWindow="div[id='discountPolicyQueryBox']";
	...
	String policyName="#policyName_DISCOUNT-bodyEl>input";
	
	String cancelMatrix="#matrixId_DISCOUNT-bodyEl>input";
	String startDate="#startDate_DISCOUNT-triggerWrap";
	String endDate="#endDate_DISCOUNT-triggerWrap";
	String today="//span[text()='Today']/..";
	String nextMonth="//div[@class='x-datepicker-next']";
	
	String originCon="#sourceCondition_DISCOUNT-bodyEl>input";
	String destCon="#destinationCondition_DISCOUNT-bodyEl>input";
	String noOfPaxCon="#noOfPaxCondition_DISCOUNT-bodyEl>input";
	String tripTypeCon="#tripTypeCondition_DISCOUNT-bodyEl>input";
	String requestTypeCon="#requestTypeCondition_DISCOUNT-bodyEl>input";


	String originTxt="#source_DISCOUNT-bodyEl>input";
	String destTxt="#destination_DISCOUNT-bodyEl>input";
	String tripTypeTxt="#tripType_DISCOUNT-bodyEl>input";
	String requestTypeTxt="#requestType_DISCOUNT-bodyEl>input";

	String addSector="#addAnotherFlightDetailsId-body>img";
	String join="#sectorRowJoin_DISCOUNT-bodyEl>input";
	String orginCont2="#sourceCondition_DISCOUNT_1-bodyEl>input";
	String orginTxt2="#source_DISCOUNT_1-bodyEl>input";
	String destCont2="#destinationCondition_DISCOUNT_1-bodyEl>input";
	String destTxt2="#destination_DISCOUNT_1-bodyEl>input";
	
	String join2="#sectorRowJoin_DISCOUNT_1-bodyEl>input";	
	String orginCont3="#sourceCondition_DISCOUNT_2-bodyEl>input";
	String orginTxt3="#source_DISCOUNT_2-bodyEl>input";
	String destCont3="#destinationCondition_DISCOUNT_2-bodyEl>input";
	String destTxt3="#destination_DISCOUNT_2-bodyEl>input";
	...
	String policyNameV,discountMatrixV,tripTypeV,requestTypeV;
	...
	public MapDiscountPolicy(WebDriver driver) {
		this.driver = driver;
	}
	
	public void mapDiscountPolicy(String reqMatx,String trip,String reqType,String filePath,String delemiter) throws IOException {
	...
	/*	List<WebElement> activeNode=driver.findElements(By.xpath(changeStatus));
		...
		*/
		...
		findEle(driver,policyName,"cssselector").sendKeys("DiscountPolicy"+getRandomNumber(10,50));
		...
		discountMatrixV=findEle(driver,cancelMatrix,"cssselector").getAttribute("value");
