...
public class SeriesDateRangeRoundTripRequestPolicy extends TestBaseSetup {
...
WebElement wbEle;	
public SeriesDateRangeRoundTripRequestPolicy(WebDriver driver) {
	this.driver = driver;
}
...
public void seriesDateRangeRequest(String org,String dest,String noPaxMn,String noPaxMx,String noInfantMn,String noInfantMx) {
	...
	waitExplicitlyByLocator(driver,selectUserBy,"cssselector",120);	
