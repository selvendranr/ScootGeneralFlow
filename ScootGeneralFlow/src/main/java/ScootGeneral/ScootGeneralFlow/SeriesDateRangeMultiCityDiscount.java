...
public class SeriesDateRangeMultiCityDiscount extends TestBaseSetup {
...
WebElement wbEle;	
public SeriesDateRangeMultiCityDiscount(WebDriver driver) {
	this.driver = driver;
}

public void seriesDateRangeRequest(String org,String dest,String org2,String dest2,String org3,String dest3) {
