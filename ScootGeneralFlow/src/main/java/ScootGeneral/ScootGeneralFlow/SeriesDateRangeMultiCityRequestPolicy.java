...
public class SeriesDateRangeMultiCityRequestPolicy extends TestBaseSetup {
...
String multiCity = "label[for='tripType_multiCity'] span";
...
String requestor;
String groupNameV,originV1,destinationV1,originV2,destinationV2,originV3,destinationV3,adultV,childV,infantV,expectedFareV,remarkV;
...
WebElement wbEle;	
public SeriesDateRangeMultiCityRequestPolicy(WebDriver driver) {
	this.driver = driver;
}

public void seriesDateRangeRequest(String org,String dest,String noPaxMn,String noPaxMx,String noInfantMn,String noInfantMx,String filePath,String delemiter) {
...
//--
	  findEle(driver,origin+"1]","cssselector").sendKeys(sectorDetails[0]);
		try {
			Thread.sleep(3000);
		} catch (InterruptedException e1) {
			// TODO Auto-generated catch block
		...
		findEle(driver,destination+"1]","cssselector").sendKeys(sectorDetails[1]);
		try {
			Thread.sleep(3000);
		} catch (InterruptedException e1) {
			// TODO Auto-generated catch block
	  ...
	  findEle(driver,origin+"2]","cssselector").sendKeys(sectorDetails[2]);
		try {
			Thread.sleep(3000);
		} catch (InterruptedException e1) {
			// TODO Auto-generated catch block
		...
		findEle(driver,destination+"2]","cssselector").sendKeys(sectorDetails[3]);
		try {
			Thread.sleep(3000);
		} catch (InterruptedException e1) {
			// TODO Auto-generated catch block
	  ...
	  /*
		 ...
		 */
		 noPaxMnN=Integer.parseInt(noPaxMn);
		  ...
		  expectedFareV=findEle(driver,departExpectedFare+"0]","cssselector").getAttribute("value");
