...
public class AdhocOneWayDiscount extends TestBaseSetup {
...
String currencyType="currencyType0";
...
Actions act=null;
WebElement wbEle;	
public AdhocOneWayDiscount(WebDriver driver) {
	this.driver = driver;
}

public void adHocGroupRequest(String org,String dest) {
	...
	try {
	  ...
	  paxInput(getRandomNumber(15,20),getRandomNumber(1,5),getRandomNumber(1,3));
		...
		//  f1=""+getRandomNumber(1,3); 
		 ...
		 // select=new Select(findEle(driver,currencyType,"id"));
