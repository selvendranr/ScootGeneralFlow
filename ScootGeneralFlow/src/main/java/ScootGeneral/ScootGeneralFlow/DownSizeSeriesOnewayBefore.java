...
public class DownSizeSeriesOnewayBefore extends TestBaseSetup {
...
protected WebDriver driver;
	...
	//-----------------Left Column details------------------------------//
	String groupResizeWindow="primaryPopupContent";//Id

	//-----------------TIME LIMIT details------------------------------//
	String firstP1="//td[contains(text(),'Group ";
	String upSizeLink="')]/following-sibling::td[3]/a[1]";
	String downSizeLink="')]/following-sibling::td[3]/a";
	String modifyLink="')]/following-sibling::td[3]/a[3]";
	
	
	
	String changeWindow="changeGroupRequestWindow";
...
//	String infantNew="#newInfantCount-triggerWrap>div";
	...
	String suceedMsg="//span[contains(text(),'successfully')]";
	...
	Select select;
	public DownSizeSeriesOnewayBefore(WebDriver driver) {
		this.driver = driver;
	}
	...
	// Starts 
	waitExplicitlyByLocator(driver,groupResizeWindow,"id",120);	
	try {
		Thread.sleep(1000);
	...
	findEle(driver,firstP1+1+downSizeLink,"xpath").click();
