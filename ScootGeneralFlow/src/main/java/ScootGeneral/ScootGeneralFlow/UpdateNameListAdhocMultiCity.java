...
public class UpdateNameListAdhocMultiCity extends TestBaseSetup {
...
protected WebDriver driver;
	...
	Select select;
	public UpdateNameListAdhocMultiCity(WebDriver driver) {
		this.driver = driver;
	}
	 ...
	 waitExplicitlyByLocator(driver,succedMassage,"cssselector",50);		
		...
		System.out.println(webEle.getText());
		 ...
		 findEle(driver,succedMsgOkBtn,"cssselector").click();	
	 		...
	 		System.out.println("Success Message  Button is not displayed");
	 	}
