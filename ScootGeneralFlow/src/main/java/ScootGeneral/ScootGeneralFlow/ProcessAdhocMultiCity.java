...
public class ProcessAdhocMultiCity extends TestBaseSetup {
...
String discountTab2="#selectedFlightTabPanelId>div:nth-of-type(2)>div:first-of-type>div:first-of-type>div:nth-of-type(2) button";
String discountTab3="#selectedFlightTabPanelId>div:nth-of-type(2)>div:first-of-type>div:first-of-type>div:last-of-type button";
...
String secondDateSF="#selectedFlightGrid-body>div>table tr:nth-of-type(3) td:nth-of-type(5)";
String thirdDateSF="#selectedFlightGrid-body>div>table tr:nth-of-type(4) td:nth-of-type(5)";
...
String loadFactor2V;
String fareTypeSF3V,dispFareSF3V,staticFareSF3V,bitPriceSF3V,departDateSF3V;
String loadFactor3V;
...
String discount3V;
String adultDispFare3V,childDispFare3V,adultNewFare3V,childNewFare3V,adultDiscountFare3V,childDiscountFare3V;
...
float adultActual3F,childActual3F,adultNewFare3F,childNewFare3F,adultDiscount3F,childDiscount3F;
float discount3F;
...
float dispFareSFF3,staticFareSFF3,bitPriceSFF3;
...
private Login login;
	...
	public ProcessAdhocMultiCity(WebDriver driver) {
		this.driver = driver;
	}
	 ...
	 findEle(driver,closeRequstHist,"xpath").click();
		...
		try {
		 ...
		 try{
			 ...
			 waitExplicitlyNotByLocator(driver,processing,"xpath",120);
			 processingTime.stop();
			 flightLoadTrip2V=flightLoadTrip2V+processingTime.getTime();
		...
		try{
			 ...
			 waitExplicitlyByLocator(driver,selectFlightImage+secondPart+fareLoad,"xpath",10);
			 processingTime.stop();
			 fareLoadTrip2V=fareLoadTrip2V+processingTime.getTime();
			 processingTime.reset();	
		...
		try {
		 ...
		 try{
			 ...
			 waitExplicitlyNotByLocator(driver,processing,"xpath",120);
			 processingTime.stop();
			 flightLoadTrip3V=flightLoadTrip3V+processingTime.getTime();
			 processingTime.reset();	
		...
		try{
			 ...
			 waitExplicitlyByLocator(driver,selectFlightImage+secondPart+fareLoad,"xpath",10);
			 processingTime.stop();
			 fareLoadTrip3V=fareLoadTrip3V+processingTime.getTime();
			 processingTime.reset();	
		...
		try {
		 ...
		 waitExplicitlyByLocator(driver,selectFlightImage,"xpath",120);
			...
			try {
			 ...
			 try{
				 waitExplicitlyByLocator(driver,processing,"xpath",5);
				 waitExplicitlyNotByLocator(driver,processing,"xpath",130);
			...
			try {
			 ...
			 waitExplicitlyByLocator(driver,selectFlightImage,"xpath",130);
				findEle(driver,selectFlightImage+secondPart,"xpath").click();
				try{
					 waitExplicitlyByLocator(driver,processing,"xpath",5);
		 			 waitExplicitlyNotByLocator(driver,processing,"xpath",130);
				...
				try{
				 waitExplicitlyByLocator(driver,selectFlightImage+secondPart+"/a","xpath",130);
				}
			 	catch(TimeoutException e){
			 		System.out.println("Fare is not Loaded  ");
			 	}
				...
				discount3V=findEle(driver,"("+selectedFlightImage+discountColumn+")[3]","xpath").getText();
				if(discount3V.contains("%")){
				act=new Actions(driver);
				act.moveToElement(findEle(driver,"("+selectedFlightImage+secondPart+fareLoad+")[3]","xpath")).doubleClick().build().perform();
				...
				try {
				 ...
				 waitExplicitlyByLocator(driver,fareDeatails,"id",60);
				findEle(driver,discountTab3,"cssselector").click();
				try {
					Thread.sleep(1000);
				} catch (InterruptedException e) {
					// TODO Auto-generated catch block
				...
				adultDispFare3V=findEle(driver,"("+adultDispFare+")[3]","xpath").getText();
				childDispFare3V=findEle(driver,"("+childDispFare+")[3]","xpath").getText();
				adultNewFare3V=findEle(driver,"("+adultNewFare+")[3]","xpath").getText();
				childNewFare3V=findEle(driver,"("+childNewFare+")[3]","xpath").getText();
				adultDiscountFare3V=findEle(driver,"("+adultDiscountFare+")[3]","xpath").getText(); 
				childDiscountFare3V=findEle(driver,"("+childDiscountFare+")[3]","xpath").getText(); 
				childDiscountFare3V=findEle(driver,"("+childDiscountFare+")[3]","xpath").getText(); 
				act=new Actions(driver);
				act.moveToElement(findEle(driver,"("+discountDeatails2+")[3]","xpath")).doubleClick().build().perform();
				try {
					Thread.sleep(3000);
				} catch (InterruptedException e) {
					// TODO Auto-generated catch block
				 ...
				 findEle(driver,closeFareDeails,"xpath").click();
				 System.out.println(adultDispFare3V+"\t"+childDispFare3V+"\t"+adultNewFare3V+"\t"+childNewFare3V+"\t"+adultDiscountFare3V+"\t"+childDiscountFare3V);
				 ...
				 discountCalculation3();
					...
					System.out.println("Discount is NA for 3 rd Sector");
				}	
	}
...
public void discountCalculation3(){
		...
		adultNewFare3F=Float.parseFloat(adultNewFare3V.substring(adultNewFare3V.indexOf("(")+1, adultNewFare3V.indexOf("+")));
		childNewFare3F=Float.parseFloat(childNewFare3V.substring(childNewFare3V.indexOf("(")+1, childNewFare3V.indexOf("+")));
		adultDiscount3F=Float.parseFloat(adultDiscountFare3V);		
		childDiscount3F=Float.parseFloat(childDiscountFare3V);
		...
		System.out.println("Actual adult "+ adultActual3F);
		System.out.println("Actual child "+ childActual3F);
...
public void checkStaticPolicy(){
	...
	try {
	 ...
	 waitExplicitlyByLocator(driver,selectFlightImage,"xpath",120);
		...
		departDateSF2V=findEle(driver,secondDateSF,"cssselector").getText();
	...
	//------------------End 
		...
		try {
		 ...
		 waitExplicitlyByLocator(driver,selectFlightImage,"xpath",120);
			...
			loadFactor3V=findEle(driver,"("+selectedFlightImage+currentLFSF+")[3]","xpath").getText();
			loadFactorI3=Integer.parseInt(loadFactor3V);
			...
			// Point coordinates3=findEle(driver,"("+adultDispFare+")[3]","xpath").getLocation();
			 //try {
			 //	Robot robot = new Robot();
			 //	robot.mouseMove(x, y);
			 //	robot.mouseMove(coordinates3.x+30,coordinates3.y);
			// } catch (AWTException e1) {
			 //TODO Auto-generated catch block
			 //	e1.printStackTrace();
			// }
			...
			// act.build().perform();
			 ...
			 js3.executeScript("arguments[0].onmouseover()", findEle(driver,"("+adultDispFare+")[3]","xpath"));
			try {
				Thread.sleep(5000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
			...
			try{
			waitExplicitlyByLocator(driver,fareTypeSF,"cssselector",10);
			fareTypeSF3V=findEle(driver,fareTypeSF,"cssselector").getText();
			dispFareSF3V=findEle(driver,dispFareSF,"cssselector").getText();
			staticFareSF3V=findEle(driver,staticFareSF,"cssselector").getText();
			bitPriceSF3V=findEle(driver,bitPriceSF,"cssselector").getText();

			}catch(TimeoutException e){
				System.out.println("Public fare exception e");
				fareTypeSF3V=findEle(driver,fareTypePublicSF,"cssselector").getText();
				dispFareSF3V=findEle(driver,dispFareSF,"cssselector").getText();
				//staticFareSFV=findEle(driver,staticFareSF,"cssselector").getText();
				bitPriceSF3V=findEle(driver,bitPriceSF,"cssselector").getText();
			...
			departDateSF3V=findEle(driver,thirdDateSF,"cssselector").getText();
			daysToDepartI3=calculateDays(departDateSF3V);	
			 ...
			 findEle(driver,closeFareDeails,"xpath").click();
			System.out.println("All the values are");
			System.out.println( fareTypeSF3V+"\t"+dispFareSF3V+"\t"+staticFareSF3V+"\t"+bitPriceSF3V+"\t"+departDateSF3V+"\t"+loadFactor3V);
			System.out.println(loadFactorI3+"\t"+daysToDepartI3);
...
public void saticFareCalculation2(){adultActual2F=Float.parseFloat(adultDispFare2V.substring(adultDispFare2V.indexOf("(")+1, adultDispFare2V.indexOf("+")));
childActual2F=Float.parseFloat(childDispFare2V.substring(childDispFare2V.indexOf("(")+1, childDispFare2V.indexOf("+")));
...
System.out.println("Actual Fare 2 " + adultActual2F);
System.out.println("Displayed Disp Fare  2 " + dispFareSFF2);
System.out.println("Displayed Static Fare 2 " + staticFareSFF2);
System.out.println("Displayed Bit price Fare 2 " + bitPriceSFF2);
		}


public void saticFareCalculation3(){adultActual3F=Float.parseFloat(adultDispFare3V.substring(adultDispFare3V.indexOf("(")+1, adultDispFare3V.indexOf("+")));
childActual3F=Float.parseFloat(childDispFare3V.substring(childDispFare3V.indexOf("(")+1, childDispFare3V.indexOf("+")));
dispFareSF3V=dispFareSF3V.substring(dispFareSF3V.indexOf(":")+1);
dispFareSF3V=dispFareSF3V.replaceAll("\\s+", "");
dispFareSFF3=Float.parseFloat(dispFareSF3V);
if(staticFareSF3V != null && !staticFareSF3V.isEmpty()) {
staticFareSF3V=staticFareSF3V.substring(staticFareSF3V.indexOf(":")+1);
staticFareSF3V=staticFareSF3V.replaceAll("\\s+", "");
staticFareSFF3=Float.parseFloat(staticFareSF3V);
}
bitPriceSF3V=bitPriceSF3V.substring(bitPriceSF3V.indexOf(":")+1);
bitPriceSF3V=bitPriceSF3V.replaceAll("\\s+", "");
bitPriceSFF3=Float.parseFloat(bitPriceSF3V);

System.out.println("Actual Fare 3" + adultActual3F);
System.out.println("Displayed Disp Fare 3 " + dispFareSFF3);
System.out.println("Displayed Static Fare 3 " + staticFareSFF3);
System.out.println("Displayed Bit price Fare 3  " + bitPriceSFF3);
		}
