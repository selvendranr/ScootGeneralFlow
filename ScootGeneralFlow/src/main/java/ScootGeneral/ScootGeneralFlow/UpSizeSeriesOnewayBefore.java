...
public class UpSizeSeriesOnewayBefore extends TestBaseSetup {
...
protected WebDriver driver;
	...
	String downSizeLink="')]/following-sibling::td[3]/a[2]";
	...
	Select select;
	public UpSizeSeriesOnewayBefore(WebDriver driver) {
		this.driver = driver;
	}
	...
	// Starts 
		...
		findEle(driver,firstP1+1+upSizeLink,"xpath").click();
