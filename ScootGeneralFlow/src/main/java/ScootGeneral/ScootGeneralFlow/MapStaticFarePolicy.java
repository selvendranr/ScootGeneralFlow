...
public class MapStaticFarePolicy extends TestBaseSetup {
...
protected WebDriver driver;
	...
	String mapMatrix="ul>li[class='staticFarePolicyQueryBox']>a";

	String create="//span[text()='Create']/..";
	String requestWindow="createPolicy_STATICFARE-body";
	...
	String flightNumber="//li[text()='Flight number']";
	...
	String policyName="#policyName_STATICFARE-bodyEl>input";
	
	String staticMatrix="#matrixId_STATICFARE-bodyEl>input";
	String startDate="#startDate_STATICFARE-triggerWrap";
	String endDate="#endDate_STATICFARE-triggerWrap";
	String today="//span[text()='Today']/..";
	String nextMonth="//div[@class='x-datepicker-next']";
	
	String originCon="#sourceCondition_STATICFARE-bodyEl>input";
	String destCon="#destinationCondition_STATICFARE-bodyEl>input";
	String noOfPaxCon="#noOfPaxCondition_STATICFARE-bodyEl>input";
	String tripTypeCon="#tripTypeCondition_STATICFARE-bodyEl>input";
	String requestTypeCon="#requestTypeCondition_STATICFARE-bodyEl>input";


	String originTxt="#source_STATICFARE-bodyEl>input";
	String destTxt="#destination_STATICFARE-bodyEl>input";
	String tripTypeTxt="#tripType_STATICFARE-bodyEl>input";
	String requestTypeTxt="#requestType_STATICFARE-bodyEl>input";

	String addSector="#addAnotherFlightDetailsId-body>img";
	String join="#sectorRowJoin_STATICFARE-bodyEl>input";
	String orginCont2="#sourceCondition_STATICFARE_1-bodyEl>input";
	String orginTxt2="#source_STATICFARE_1-bodyEl>input";
	String destCont2="#destinationCondition_STATICFARE_1-bodyEl>input";
	String destTxt2="#destination_STATICFARE_1-bodyEl>input";
	
	String join2="#sectorRowJoin_STATICFARE_1-bodyEl>input";	
	String orginCont3="#sourceCondition_STATICFARE_2-bodyEl>input";
	String orginTxt3="#source_STATICFARE_2-bodyEl>input";
	String destCont3="#destinationCondition_STATICFARE_2-bodyEl>input";
	String destTxt3="#destination_STATICFARE_2-bodyEl>input";
	...
	public MapStaticFarePolicy(WebDriver driver) {
		this.driver = driver;
	}
	
	public void mapSFPolicy(String reqMatx,String trip,String reqType,String filePath,String delemiter) throws IOException {
		...
		findEle(driver,settings+staticFare,"cssselector").click();
		try {
			Thread.sleep(1000);
		} catch (InterruptedException e1) {
			// TODO Auto-generated catch block
	...
	/*	List<WebElement> activeNode=driver.findElements(By.xpath(changeStatus));
		...
		*/
			...
			e1.printStackTrace();
			 ...
			 findEle(driver,tripType,"xpath").click();
				...
				try {
				 ...
				 findEle(driver,flightNumber,"xpath").click();
					try {
						Thread.sleep(1000);
					} catch (InterruptedException e1) {
						// TODO Auto-generated catch block
		...
		findEle(driver,policyName,"cssselector").sendKeys("StaticFarePolicy"+getRandomNumber(10,50));
