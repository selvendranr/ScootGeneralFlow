...
public class SeriesDateRangeRoundTripDiscount extends TestBaseSetup {
...
String roundTrip = "label[for='tripType_roundTrip'] span";
...
WebElement wbEle;	
public SeriesDateRangeRoundTripDiscount(WebDriver driver) {
	this.driver = driver;
}

public void seriesDateRangeRequest(String org,String dest) {
