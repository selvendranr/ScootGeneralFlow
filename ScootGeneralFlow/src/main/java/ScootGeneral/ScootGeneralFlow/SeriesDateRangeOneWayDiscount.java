...
public class SeriesDateRangeOneWayDiscount extends TestBaseSetup {
...
String oneWayTrip = "label[for='tripType_oneWay'] a";
...
private Actions act;
WebElement wbEle;	
public SeriesDateRangeOneWayDiscount(WebDriver driver) {
	this.driver = driver;
}
