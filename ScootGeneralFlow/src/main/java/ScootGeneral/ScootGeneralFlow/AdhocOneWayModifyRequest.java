...
public class AdhocOneWayModifyRequest extends TestBaseSetup {
...
Actions act=null;
WebElement wbEle;	
public AdhocOneWayModifyRequest(WebDriver driver) {
	this.driver = driver;
}
...
public void adHocGroupRequest(String filePath,String delemiter) {
	...
	*/
	...
	try {
	  ...
	  paxInput(getRandomNumber(12,15),getRandomNumber(1,5),getRandomNumber(1,3));
