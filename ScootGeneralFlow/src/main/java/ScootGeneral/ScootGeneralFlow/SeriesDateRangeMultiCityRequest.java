...
public class SeriesDateRangeMultiCityRequest extends TestBaseSetup {
...
WebElement wbEle;	
public SeriesDateRangeMultiCityRequest(WebDriver driver) {
	this.driver = driver;
}

public void seriesDateRangeRequest(String org,String dest,String noPax,String filePath,String delemiter) {
