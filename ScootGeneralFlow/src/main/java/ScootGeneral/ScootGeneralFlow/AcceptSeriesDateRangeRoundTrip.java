...
public class AcceptSeriesDateRangeRoundTrip extends TestBaseSetup {
	
protected WebDriver driver;
	
	String requestInfo="a[title='Response']";
	...
	//double processingTimeV,acceptTimeV;
	
	private Login login;
	private WebElement webEle;
	Select select;
	public AcceptSeriesDateRangeRoundTrip(WebDriver driver) {
		this.driver = driver;
	}
