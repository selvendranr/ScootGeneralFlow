...
public class AdhocMultiCityRequestPolicy extends TestBaseSetup {
...
WebElement wbEle;	
public AdhocMultiCityRequestPolicy(WebDriver driver) {
	this.driver = driver;
}

public void adHocGroupRequest(String org,String dest,String noPaxMn,String noPaxMx,String noInfantMn,String noInfantMx,String filePath,String delemiter) {
			...
			select=new Select(findEle(driver,groupCategory,"cssselector"));
			  ...
			  paxMinimumError1V=findEle(driver,errorMsg,"xpath").getText();
				...
				try {
				  ...
				  btn=driver.findElements(By.cssSelector(submitButton));
				  btn.get(1).sendKeys(Keys.ENTER);
				  waitExplicitlyByLocator(driver,errorMsg,"xpath",30);	
