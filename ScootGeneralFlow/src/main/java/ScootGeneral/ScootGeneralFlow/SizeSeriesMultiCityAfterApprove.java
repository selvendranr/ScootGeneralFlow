...
public class SizeSeriesMultiCityAfterApprove extends TestBaseSetup {
...
protected WebDriver driver;
	...
	String requestIDV,sectorV,travelDateV,noOfPaxV;
	...
	Select select;
	public SizeSeriesMultiCityAfterApprove(WebDriver driver) {
		this.driver = driver;
	}
	...
	findEle(driver,adultTxt,"name").sendKeys(""+getRandomNumber(13,19));
	findEle(driver,childTxt,"name").sendKeys(""+getRandomNumber(4,6));
