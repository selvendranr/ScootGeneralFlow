...
public class ProcessNegoAdhocMultiCity extends TestBaseSetup {
...
protected WebDriver driver;
	...
	public ProcessNegoAdhocMultiCity(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void processAdHocRequest(String groupID) throws IOException {
		...
		System.out.println("Adhoc Multi city Group Request Processsing is started");
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
	...
	try{
		...
		try{
	 		 waitExplicitlyByLocator(driver,selectFlightImage+secondPart,"xpath",60);
	 
			 findEle(driver,selectFlightImage+secondPart,"xpath").click();
		}catch(TimeoutException e){
	 		System.out.println("Fare is not loaded for 2");
	 	 	}	
	...
	try{
 		waitExplicitlyByLocator(driver,selectFlightImage+secondPart+fareLoad,"xpath",30);
  		}
	 	catch(TimeoutException e){
		...
		findEle(driver,selectFlightImage,"xpath").click();
	 	...
	 	System.out.println("Flight Already Loaded For Trip 2");
 	 	}
		...
		try{
			waitExplicitlyByLocator(driver,processing,"xpath",5);
	  		 waitExplicitlyNotByLocator(driver,processing,"xpath",120);
		 		...
		 		System.out.println("Fare Already Loaded for sector 3");
		 	}
	...
	try{	
		...
		findEle(driver,selectFlightImage,"xpath").click();
	 	...
	 	System.out.println("Flight already  Already Loaded For Trip 3");
 	 	}
